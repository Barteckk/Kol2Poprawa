    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 20, "Jan", "Kwiatek", 50 },
                    { 2, 50, "Miłosz", "Dziuba", 70 },
                    { 3, 100, "Norbi", "Czaban", 150 }
                });

            migrationBuilder.InsertData(
                table: "Item",
                columns: new[] { "ItemId", "ItemName", "Weight" },
                values: new object[,]
                {
                    { 1, "tor numero uno", 20 },
                    { 2, "nigol", 50 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 6, 17, 12, 33, 4, 824, DateTimeKind.Local).AddTicks(2682) },
                    { 2, 2, new DateTime(2025, 6, 17, 12, 33, 4, 825, DateTimeKind.Local).AddTicks(8426) },
                    { 3, 3, new DateTime(2025, 6, 17, 12, 33, 4, 825, DateTimeKind.Local).AddTicks(8445) }
                });
